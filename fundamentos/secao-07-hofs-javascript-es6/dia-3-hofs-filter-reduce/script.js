...
const getTotalArea = (countries) => countries.reduce((acc, country) => acc + country.area, 0);

// Exercicio 3

const getlongestName = (countries) => countries.reduce((acc, country) => acc.name.length > country.name.length ? acc : country);
